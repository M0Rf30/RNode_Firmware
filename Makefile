...
# The Wio Tracker L1 bootloader carries SoftDevice S140 7.3.0, which starts the
# application at 0x27000. The Adafruit nRF52 core ships the S140 7.3.0 API headers
# (selected with build.sd_version) but its only v7 linker script is sized for the
# nRF52833, so the nRF52840 one lives here.
NRF52840_S140_V7_LD = $(CURDIR)/linker/nrf52840_s140_v7.ld
...
firmware-wio_l1:
	arduino-cli compile --log --fqbn adafruit:nrf52:pca10056 -e --build-property "build.sd_version=7.3.0" --build-property "build.ldscript=$(NRF52840_S140_V7_LD)" --build-property "compiler.cpp.extra_flags=\"-DBOARD_MODEL=0x53\""

firmware-wio_l1_1w:
	arduino-cli compile --log --fqbn adafruit:nrf52:pca10056 -e --build-property "build.sd_version=7.3.0" --build-property "build.ldscript=$(NRF52840_S140_V7_LD)" --build-property "compiler.cpp.extra_flags=\"-DBOARD_MODEL=0x53\" \"-DBOARD_VARIANT=0x1A\""
...
release-wio_l1:
	arduino-cli compile --fqbn adafruit:nrf52:pca10056 -e --build-property "build.sd_version=7.3.0" --build-property "build.ldscript=$(NRF52840_S140_V7_LD)" --build-property "compiler.cpp.extra_flags=\"-DBOARD_MODEL=0x53\""
	cp build/adafruit.nrf52.pca10056/RNode_Firmware.ino.hex build/rnode_firmware_wio_l1.hex
...
release-wio_l1_1w:
	arduino-cli compile --fqbn adafruit:nrf52:pca10056 -e --build-property "build.sd_version=7.3.0" --build-property "build.ldscript=$(NRF52840_S140_V7_LD)" --build-property "compiler.cpp.extra_flags=\"-DBOARD_MODEL=0x53\" \"-DBOARD_VARIANT=0x1A\""
	cp build/adafruit.nrf52.pca10056/RNode_Firmware.ino.hex build/rnode_firmware_wio_l1_1w.hex
	adafruit-nrfutil dfu genpkg --dev-type 0x0052 --application build/rnode_firmware_wio_l1_1w.hex Release/rnode_firmware_wio_l1_1w.zip
